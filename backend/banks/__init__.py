...
def _get_bank_module(bank_key: str):
    if not _BANK_MODULES:
        from . import icici, sbi, axis_neo, axis, hdfc, kotak, indusind, au, boi, bob, csb, kokan, canara, federal, indian, saraswat, standard_chartered, cosmos, bom, bandhan, yes_bank, union_bank, cbi, pnb, idfc, dcb, idbi, karnataka, rbl, apna_sahakari, bharat, esaf, svc, bccb, sib, tjsb, hsbc, dbs, generic
        ...
        _BANK_MODULES["pnb"] = pnb
        _BANK_MODULES["idfc"] = idfc
        _BANK_MODULES["dcb"] = dcb
        _BANK_MODULES["idbi"] = idbi
        _BANK_MODULES["karnataka"] = karnataka
        _BANK_MODULES["rbl"] = rbl
        _BANK_MODULES["apna_sahakari"] = apna_sahakari
        _BANK_MODULES["bharat"] = bharat
        _BANK_MODULES["esaf"] = esaf
        _BANK_MODULES["svc"] = svc
        _BANK_MODULES["bccb"] = bccb
        _BANK_MODULES["sib"] = sib
        _BANK_MODULES["tjsb"] = tjsb
        _BANK_MODULES["hsbc"] = hsbc
        _BANK_MODULES["dbs"] = dbs
